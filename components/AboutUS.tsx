            ...
            <article className="my-14 ">
              <div className="flex flex-col justify-between items-center lg:flex-row gap-10">
                <p className="text-base text-left order-3 lg:order-none text-dark">
                  <span className="text-primary text-center text-base lg:text-lg mb-16 font-semibold ">
                    Our Mission
                  </span>
                  <br />
                  ...
                  strive to provide access to the best educational
                  opportunities, resources, and support systems, enabling
                  students to excel academically, professionally, and
                  personally. Through our services, we aim to make a positive
                  and lasting impact on the lives of students and professionals
                  (both skilled and unskilled), helping them shape a brighter
                  future for themselves and society.
                </p>
