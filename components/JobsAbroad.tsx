        ...
        <div className="flex flex-col md:flex-row justify-between lg:gap-10">
          ...
          <div className="flex-1 flex flex-col gap-8">
            ...
            <p className="text-lg text-dark">
              ...
              industries, increasing your exposure to exciting job
              opportunities. Our career consultants will support you throughout
              the job search process, from identifying suitable openings to
              helping you perfect your applications. We're dedicated to helping
              you secure a fulfilling and rewarding career.
            </p>
          </div>
        </div>
      </div>
