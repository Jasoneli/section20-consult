        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          <div className="flex-1 flex flex-col gap-8">
            ...
            <p className="text-dark">
              ...
              looking to enhance your skills through a specialized course, we've
              got you covered. Our expert counselors will guide you through the
              entire process, from choosing the right destination and
              institution to handling visa applications and accommodation
              arrangements. Experience a transformative educational journey that
              expands your horizons and enriches your perspective.
            </p>
          </div>
          <div className="">
            <Image
