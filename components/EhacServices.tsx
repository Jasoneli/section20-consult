        ...
        <div className="mt-5 text-white flex flex-col lg:flex-row gap-8 pb-10">
          <div className="flex flex-col gap-2">
            ...
            <p className="lg:text-center">
              ...
              medications, common health risks in your destination country, and
              preventive measures.
            </p>
          </div>
          <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="lg:text-center">
              Your mental well-being is just as crucial as your physical health.
              We offer resources and counseling services to address the
              emotional aspects of studying abroad, homesickness, cultural
